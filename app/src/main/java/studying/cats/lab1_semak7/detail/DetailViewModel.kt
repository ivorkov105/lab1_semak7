    ...
    fun addElement(header: Comparable<*>, associatedList: List<Comparable<*>>) {
        performOperation { oldList ->
            when (header) {
                is String -> {
                    @Suppress("UNCHECKED_CAST")
                    HeadersListFactory.add(oldList as HeadersList<String>, header, associatedList as List<String>)
                }
                is Point2D -> {
                    @Suppress("UNCHECKED_CAST")
                    HeadersListFactory.add(oldList as HeadersList<Point2D>, header, associatedList as List<Point2D>)
                }
                is CustomDate -> {
                    @Suppress("UNCHECKED_CAST")
                    HeadersListFactory.add(oldList as HeadersList<CustomDate>, header, associatedList as List<CustomDate>)
                }
                else -> oldList
            }
        }
    ...
    fun addElementAt(index: Int, header: Comparable<*>, associatedList: List<Comparable<*>>) {
        performOperation { oldList ->
            ...
            when (header) {
                is String -> {
                    @Suppress("UNCHECKED_CAST")
                    HeadersListFactory.add(oldList as HeadersList<String>, index, header, associatedList as List<String>)
                }
                is Point2D -> {
                    @Suppress("UNCHECKED_CAST")
                    HeadersListFactory.add(oldList as HeadersList<Point2D>, index, header, associatedList as List<Point2D>)
                }
                is CustomDate -> {
                    @Suppress("UNCHECKED_CAST")
                    HeadersListFactory.add(oldList as HeadersList<CustomDate>, index, header, associatedList as List<CustomDate>)
                }
                else -> oldList
            }
        }
    ...
    fun addSortedElement(header: Comparable<*>, associatedList: List<Comparable<*>>) {
        performOperation { oldList ->
            when (header) {
                is String -> {
                    @Suppress("UNCHECKED_CAST")
                    HeadersListFactory.addSorted(oldList as HeadersList<String>, header, associatedList as List<String>)
                }
                is Point2D -> {
                    @Suppress("UNCHECKED_CAST")
                    HeadersListFactory.addSorted(oldList as HeadersList<Point2D>, header, associatedList as List<Point2D>)
                }
                is CustomDate -> {
                    @Suppress("UNCHECKED_CAST")
                    HeadersListFactory.addSorted(oldList as HeadersList<CustomDate>, header, associatedList as List<CustomDate>)
                }
                else -> oldList
            }
        }
